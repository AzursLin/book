    ...
    <el-row>
      <el-col :span="24">
        <el-table
          ...
          <el-table-column property="name" label="菜名">
          </el-table-column>
          <el-table-column property="url" label="图片地址">
          </el-table-column>
    ...
    <el-dialog
      ...
      <el-form ref="setForm" :model="setForm" label-width="80px">
        <el-form-item label="菜名">
          <el-input v-model="setForm.name" placeholder="请输入内容"></el-input>
        </el-form-item>
        <el-form-item label="图片地址">
          <el-input v-model="setForm.url" placeholder="请输入内容"></el-input>
        </el-form-item>
      </el-form>
...
<script>
  import { getDishList,saveDish,userUpdata,deleteDish } from '../api/api';
export default {
  name: 'hello',
  data () {
    return {
    ...
    methods: {
      ...
      setBt(){
        let para = this.setForm;
        if(this.mode === 1) {
          saveDish(para).then((res) => {
            let{ret,msg}=res;
