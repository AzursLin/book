    ...
    <el-row>
      <el-col :span="24">
        <el-table
          ...
          <el-table-column property="createTime" label="下单时间">
          </el-table-column>
           <el-table-column property="deskNumber" label="桌号">
          </el-table-column>
...
<script>
  import { getOrderList,saveOrder,deleteOrder } from '../api/api';
export default {
  name: 'hello',
  data () {
    return {
